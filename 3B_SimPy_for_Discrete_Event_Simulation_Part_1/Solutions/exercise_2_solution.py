...
print ("Trial Results")
print ("-------------")
print (f"Mean time in queue for registration (mins) : {mean_q_reg_trial:.2f}")
print (f"Mean time in queue for consultation (mins) : {mean_q_con_trial:.2f}")
print (f"Mean time in queue for booking test (mins) : {mean_q_book_trial:.2f}")
print (f"Mean time in system (mins) : {mean_tis_trial:.2f}")
