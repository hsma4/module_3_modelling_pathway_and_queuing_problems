...
print ("Mean queuing time for registration :",
       f"{mean_queue_time_registration:.2f} minutes")
print ("Mean queuing time for consultation :",
       f"{mean_queue_time_consultation:.2f} minutes")
print ("Mean queuing time for booking test :",
       f"{mean_queue_time_book_test:.2f} minutes")
print ("Mean time in system :",
       f"{mean_time_in_system:.2f} minutes")
